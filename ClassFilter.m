...
% %=================================================
%                 if isequal(obj.Order, [1, 2])
%                     FreqIn = FreqErInput  * obj.CoefsFLL(1);
%                     PhaseIn1 = PhaseErInput * obj.CoefsPLL(1);
%                     PhaseIn2 = PhaseErInput * obj.CoefsPLL(2);
%                     Output = ...
%                          0.5 * obj.VelocAcc +...
%                         ...
%                         0.5 * (obj.VelocAcc + PhaseIn1*obj.T + FreqIn*obj.T) + ...
%                         ...
%                         PhaseIn2;
% 
%                     obj.VelocAcc = obj.VelocAcc + ...
...
%%=====================================================
%                 if isequal(obj.Order, [1, 2])
%                     FreqIn = FreqErInput  * 1*obj.T;
%                     PhaseIn1 = PhaseErInput * 1*obj.T;
%                     PhaseIn2 = PhaseErInput * 1;
%                     Output = ...
%                          0.5 * obj.VelocAcc +...
%                         ...
%                         0.5 * (obj.VelocAcc + PhaseIn1 + FreqIn) + ...
%                         ...
%                         PhaseIn2;
% 
%                     obj.VelocAcc = obj.VelocAcc + ...
...
%                     Output = ...
%                         FreqErInput *1* 0.5 + ...
%                         FreqErInput *1* (1 * 0.5)^2 + ...
%                         ...
%                         PhaseErInput *1 * (1 * 0.5)^2 + ...
%                         PhaseErInput* 1 *  1 * 0.5 + ...
%                         PhaseErInput * 1+ ...
%                         ...
%                         obj.AccelAcc * 1* 0.5 + ...
%                         obj.VelocAcc;

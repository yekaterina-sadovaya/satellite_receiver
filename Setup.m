...
%             Main.SigFileName = '30_08_2018__19_40_20_x04_1ch_16b_15pos_60000ms.dat';
    ...
    % Директория для сохранения результатов
        Main.SaveDirName = 'Results_Rate2_Coh';
...
% P20_NonCohTrackSatsAndBitSync
    ...
    % синхронизации по времени
        P20_NonCohTrackSatsAndBitSync.HalfNumCA4Sync = 5;
    ...
    % Количество бит, используемых для битовой синхронизации
        P20_NonCohTrackSatsAndBitSync.NBits4Sync = 150;
